...
class Product extends Model implements HasMedia
{
    ...
    /**
     * Get the highest supplier purchase price (for price list calculation)
     */
    ...
    {
        return Attribute::make(
            get: fn () => $this->total_stock - $this->total_reserved - $this->total_out_on_rental
        );
    }
    ...
    public function calculateCompositeSalePrice(): float
    {
        ...
        $prices = app(\App\Domains\Product\Services\ProductPricingService::class)->calculateCompositePrices($this);
