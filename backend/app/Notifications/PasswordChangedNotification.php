...
class PasswordChangedNotification extends Notification implements ShouldQueue
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        return (new MailMessage)
            ...
            ->line('')
            ->line('⚠️ **Se non hai effettuato tu questa modifica**, contattaci immediatamente.')
            ->action('Accedi al tuo Account', url('/login'))
            ->line('Le tue sessioni attive rimangono invariate. Se sospetti un accesso non autorizzato, ti consigliamo di disconnettere tutti i dispositivi dalle impostazioni del tuo account.')
            ->line('')
            ->line('Se hai domande o dubbi, contattaci.')
