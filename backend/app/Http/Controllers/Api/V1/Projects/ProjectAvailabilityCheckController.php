...
use App\Domains\Project\Data\ProjectAvailabilityCheckData;
...
class ProjectAvailabilityCheckController extends Controller
{
    ...
    public function resolveItem(ProjectAvailabilityCheckItem $item, Request $request): JsonResponse
    {
        ...
        return response()->json([
            ...
            'data' => \App\Domains\Project\Data\ProjectAvailabilityCheckItemData::fromModel($item->load(['projectMaterial.product', 'subrentalSupplier'])),
        ]);
    }
}
