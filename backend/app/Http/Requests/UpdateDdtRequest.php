...
class UpdateDdtRequest extends FormRequest
{
    public function authorize(): bool
    {
        return $this->user()->can('warehouse.edit');
    }

    public function rules(): array
    {
        $ddtId = $this->route('ddt');

        return [
            'code' => ['nullable', 'string', 'max:50', Rule::unique('ddts', 'code')->ignore($ddtId)],
            ...
            'ddt_date' => 'sometimes|required|date',
    ...
    public function messages(): array
    {
        return [
            ...
            'items.min' => 'Devi avere almeno un articolo.',
        ];
    }
}
