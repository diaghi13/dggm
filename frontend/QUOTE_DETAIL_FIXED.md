...
La pagina `/dashboard/quotes/[id]` aveva ancora molti elementi "fancy" non coerenti con il resto del sistema.
...
La pagina `/dashboard/quotes/[id]` è ora **professionale, sobria e coerente** con tutto il resto del sistema ERP.
