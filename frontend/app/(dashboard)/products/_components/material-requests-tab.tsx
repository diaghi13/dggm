...
import { MaterialRequestDetailsDialog } from '@/app/(dashboard)/products/_components/material-request-details-dialog';
...
export { MaterialRequestsTab as ProductRequestsTab };
