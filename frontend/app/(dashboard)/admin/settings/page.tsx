...
import { removeWhiteBackground, getCroppedBlob } from "@/lib/utils/image-processing";
import {
  Dialog,
  DialogContent,
  DialogHeader,
...
export default function AdminSettingsPage() {
  ...
  const [cameraTarget, setCameraTarget] = useState<"stamp" | "sigla" | null>(null);
  ...
  const [cropImageTarget, setCropImageTarget] = useState<"stamp" | "sigla" | null>(null);
  ...
  const applyCrop = async () => {
    ...
    try {
      ...
      const file = new File([blob], `${cropImageTarget}.png`, { type: "image/png" });
  ...
  useEffect(() => {
    if (companySettings) {
      ...
      if (logo) {
        setLogoPreview(logo.startsWith("http") ? logo : `${backendBase}${logo}`);
      }
      const stamp = companySettings["company.stamp"];
      if (stamp) {
        setStampPreview(stamp.startsWith("http") ? stamp : `${backendBase}${stamp}`);
      }
      const sigla = companySettings["company.sigla"];
      if (sigla) {
        setSiglaPreview(sigla.startsWith("http") ? sigla : `${backendBase}${sigla}`);
      }
    }
  ...
  const saveCompanyMutation = useMutation({
    mutationFn: async () => {
      ...
      const imageKeys = new Set(["company.logo", "company.stamp", "company.sigla"]);
              ...
              <DialogContent className="max-w-2xl">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center gap-2 p-3 rounded-lg border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800/50">
                    ...
                    />
                    <div>
                      <Label htmlFor="remove-bg" className="text-sm cursor-pointer font-medium">
                        Rimuovi sfondo bianco
                      </Label>
                      <p className="text-xs text-slate-500 dark:text-slate-400">
                        Disattiva se l&apos;immagine ha già lo sfondo trasparente
                      </p>
                    </div>
                  </div>
        ...
        <TabsContent value="quotes" className="space-y-6 mt-0">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Scegli il layout grafico usato per generare i preventivi in PDF
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  ...
                  [
                    {
                      ...
                      svg: (
                        <svg viewBox="0 0 160 120" className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
                          <rect x="0" y="0" width="160" height="120" fill="#f8fafc"/>
                          {/* Header left: logo placeholder */}
                          <rect x="6" y="5" width="18" height="13" fill="#dbeafe" rx="2"/>
                          <rect x="6" y="6.5" width="18" height="9" fill="#3b82f6" rx="1.5" opacity="0.45"/>
                          {/* Header left: company text */}
                          <rect x="28" y="6" width="35" height="3" fill="#1e293b" rx="1"/>
                          <rect x="28" y="11" width="24" height="2" fill="#94a3b8" rx="1"/>
                          <rect x="28" y="14" width="28" height="2" fill="#94a3b8" rx="1"/>
                          {/* Header right: quote info */}
                          <rect x="104" y="5" width="22" height="3.5" fill="#1e293b" rx="1"/>
                          <rect x="104" y="11" width="38" height="2" fill="#94a3b8" rx="1"/>
                          <rect x="104" y="14" width="30" height="2" fill="#94a3b8" rx="1"/>
                          {/* Separator */}
                          <rect x="6" y="22" width="148" height="1" fill="#e2e8f0"/>
                          {/* Client/project row */}
                          <rect x="6" y="27" width="26" height="2" fill="#94a3b8" rx="1"/>
                          <rect x="6" y="31" width="40" height="2.5" fill="#334155" rx="1"/>
                          <rect x="6" y="35" width="30" height="2" fill="#94a3b8" rx="1"/>
                          <rect x="92" y="27" width="20" height="2" fill="#94a3b8" rx="1"/>
                          <rect x="92" y="31" width="30" height="2" fill="#94a3b8" rx="1"/>
                          <rect x="92" y="35" width="24" height="2" fill="#94a3b8" rx="1"/>
                          {/* Table header: dark slate */}
                          <rect x="6" y="43" width="148" height="8" fill="#1e293b" rx="1.5"/>
                          <rect x="9" y="46" width="22" height="2.5" fill="#ffffff" opacity="0.5" rx="1"/>
                          <rect x="80" y="46" width="18" height="2.5" fill="#ffffff" opacity="0.5" rx="1"/>
                          <rect x="126" y="46" width="24" height="2.5" fill="#ffffff" opacity="0.5" rx="1"/>
                          {/* Table rows */}
                          <rect x="6" y="52" width="148" height="7" fill="#f8fafc"/>
                          <rect x="6" y="52" width="148" height="0.5" fill="#e2e8f0"/>
                          <rect x="9" y="54.5" width="30" height="2" fill="#334155" rx="1"/>
                          <rect x="126" y="54.5" width="24" height="2" fill="#334155" rx="1"/>
                          <rect x="6" y="59" width="148" height="7" fill="#ffffff"/>
                          <rect x="6" y="59" width="148" height="0.5" fill="#e2e8f0"/>
                          <rect x="9" y="61.5" width="24" height="2" fill="#334155" rx="1"/>
                          <rect x="126" y="61.5" width="24" height="2" fill="#334155" rx="1"/>
                          <rect x="6" y="66" width="148" height="7" fill="#f8fafc"/>
                          <rect x="6" y="66" width="148" height="0.5" fill="#e2e8f0"/>
                          <rect x="9" y="68.5" width="28" height="2" fill="#334155" rx="1"/>
                          <rect x="126" y="68.5" width="24" height="2" fill="#334155" rx="1"/>
                          {/* Totals box right: blue */}
                          <rect x="88" y="80" width="66" height="32" fill="#eff6ff" rx="2.5"/>
                          <rect x="91" y="84" width="28" height="2" fill="#94a3b8" rx="1"/>
                          <rect x="141" y="84" width="10" height="2" fill="#334155" rx="1"/>
                          <rect x="91" y="88.5" width="20" height="2" fill="#94a3b8" rx="1"/>
                          <rect x="143" y="88.5" width="8" height="2" fill="#334155" rx="1"/>
                          <rect x="88" y="94" width="66" height="10" fill="#3b82f6" rx="2"/>
                          <rect x="92" y="97.5" width="16" height="2.5" fill="#ffffff" rx="1"/>
                          <rect x="140" y="97.5" width="10" height="2.5" fill="#ffffff" rx="1"/>
                        </svg>
                      ),
                    },
                    {
                      ...
                      svg: (
                        <svg viewBox="0 0 160 120" className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
                          <rect x="0" y="0" width="160" height="120" fill="#fafaf9"/>
                          {/* Centered header: logo */}
                          <rect x="64" y="4" width="32" height="11" fill="#d1fae5" rx="1.5"/>
                          <rect x="64" y="5.5" width="32" height="7" fill="#6ee7b7" rx="1" opacity="0.45"/>
                          {/* Company name centered */}
                          <rect x="42" y="17" width="76" height="3.5" fill="#065f46" rx="1"/>
                          <rect x="50" y="22" width="60" height="2" fill="#94a3b8" rx="1" opacity="0.8"/>
                          <rect x="58" y="25.5" width="44" height="2" fill="#94a3b8" rx="1" opacity="0.7"/>
                          {/* Emerald underline */}
                          <rect x="6" y="30.5" width="148" height="1.5" fill="#059669"/>
                          {/* Quote details box: stone bg + border */}
                          <rect x="6" y="34" width="148" height="22" fill="#f5f5f4" stroke="#d1d5db" strokeWidth="0.7" rx="1.5"/>
                          <rect x="10" y="38" width="26" height="2" fill="#334155" rx="1"/>
                          <rect x="10" y="42" width="40" height="2" fill="#94a3b8" rx="1"/>
                          <rect x="10" y="46" width="32" height="2" fill="#94a3b8" rx="1"/>
                          <rect x="92" y="38" width="24" height="2" fill="#334155" rx="1"/>
                          <rect x="92" y="42" width="36" height="2" fill="#94a3b8" rx="1"/>
                          <rect x="92" y="46" width="28" height="2" fill="#94a3b8" rx="1"/>
                          {/* Table: full border, emerald header */}
                          <rect x="6" y="60" width="148" height="7" fill="#d1fae5" stroke="#d1d5db" strokeWidth="0.5"/>
                          <rect x="9" y="63" width="24" height="2" fill="#065f46" rx="1"/>
                          <rect x="90" y="63" width="18" height="2" fill="#065f46" rx="1"/>
                          <rect x="130" y="63" width="20" height="2" fill="#065f46" rx="1"/>
                          <rect x="6" y="67" width="148" height="5.5" stroke="#d1d5db" strokeWidth="0.5" fill="#ffffff"/>
                          <rect x="9" y="69.5" width="28" height="1.8" fill="#334155" rx="1"/>
                          <rect x="130" y="69.5" width="20" height="1.8" fill="#334155" rx="1"/>
                          <rect x="6" y="72.5" width="148" height="5.5" stroke="#d1d5db" strokeWidth="0.5" fill="#ffffff"/>
                          <rect x="9" y="75" width="22" height="1.8" fill="#334155" rx="1"/>
                          <rect x="130" y="75" width="20" height="1.8" fill="#334155" rx="1"/>
                          <rect x="6" y="78" width="148" height="5.5" stroke="#d1d5db" strokeWidth="0.5" fill="#ffffff"/>
                          {/* Totals: stone box right */}
                          <rect x="86" y="88" width="68" height="22" fill="#f5f5f4" stroke="#d1d5db" strokeWidth="0.5" rx="1.5"/>
                          <rect x="89" y="92" width="22" height="2" fill="#94a3b8" rx="1"/>
                          <rect x="141" y="92" width="10" height="2" fill="#334155" rx="1"/>
                          <rect x="89" y="97" width="18" height="2" fill="#94a3b8" rx="1"/>
                          <rect x="137" y="97" width="14" height="2.5" fill="#065f46" rx="1"/>
                          <rect x="86" y="102.5" width="68" height="1" fill="#059669"/>
                        </svg>
                      ),
                    },
                    {
                      ...
                      svg: (
                        <svg viewBox="0 0 160 120" className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
                          ...
                          <rect x="6" y="5" width="68" height="10" fill="#111827" rx="1.5"/>
                          <rect x="6" y="17" width="44" height="3" fill="#374151" rx="1"/>
                          {/* Company info right */}
                          <rect x="110" y="6" width="36" height="2.5" fill="#1e293b" rx="1"/>
                          <rect x="110" y="11" width="26" height="2" fill="#94a3b8" rx="1"/>
                          <rect x="110" y="15" width="30" height="2" fill="#94a3b8" rx="1"/>
                          {/* Bold border-b-4 */}
                          <rect x="6" y="23" width="148" height="3.5" fill="#000000"/>
                          {/* Cliente / Progetto */}
                          <rect x="6" y="30" width="32" height="1.5" fill="#000000" rx="1"/>
                          <rect x="6" y="33" width="22" height="2" fill="#334155" rx="1"/>
                          <rect x="6" y="37" width="30" height="1.8" fill="#94a3b8" rx="1"/>
                          <rect x="82" y="30" width="28" height="1.5" fill="#000000" rx="1"/>
                          <rect x="82" y="33" width="24" height="1.8" fill="#94a3b8" rx="1"/>
                          <rect x="82" y="37" width="18" height="1.8" fill="#94a3b8" rx="1"/>
                          {/* Table: flex-divider header */}
                          <rect x="6" y="44" width="148" height="2" fill="#000000"/>
                          <rect x="6" y="47" width="52" height="1.8" fill="#94a3b8" rx="1"/>
                          <rect x="120" y="47" width="30" height="1.8" fill="#94a3b8" rx="1"/>
                          {/* Rows */}
                          <rect x="6" y="50.5" width="148" height="0.6" fill="#e5e7eb"/>
                          <rect x="6" y="52" width="50" height="1.8" fill="#111827" rx="1"/>
                          <rect x="120" y="52" width="30" height="1.8" fill="#111827" rx="1"/>
                          <rect x="6" y="55.5" width="148" height="0.6" fill="#e5e7eb"/>
                          <rect x="6" y="57" width="40" height="1.8" fill="#111827" rx="1"/>
                          <rect x="120" y="57" width="30" height="1.8" fill="#111827" rx="1"/>
                          <rect x="6" y="60.5" width="148" height="0.6" fill="#e5e7eb"/>
                          <rect x="6" y="62" width="46" height="1.8" fill="#111827" rx="1"/>
                          <rect x="120" y="62" width="30" height="1.8" fill="#111827" rx="1"/>
                          {/* Section row */}
                          <rect x="6" y="65.5" width="148" height="5.5" fill="#f9fafb"/>
                          <rect x="6" y="65.5" width="148" height="0.6" fill="#000000"/>
                          <rect x="9" y="67.5" width="30" height="2" fill="#000000" rx="1"/>
                          {/* Totals */}
                          <rect x="80" y="76" width="74" height="2.5" fill="#d1d5db" rx="1"/>
                          <rect x="80" y="81" width="74" height="2.5" fill="#d1d5db" rx="1"/>
                          {/* Black total bar */}
                          <rect x="80" y="87" width="74" height="14" fill="#000000" rx="1.5"/>
                          <rect x="84" y="92" width="22" height="3.5" fill="#ffffff" rx="1"/>
                          <rect x="140" y="92" width="10" height="3.5" fill="#ffffff" rx="1"/>
                        </svg>
                      ),
                    },
                  ]
                ).map((tpl) => {
                  const selectedKey = getSettingValue("company.quote_template") || "modern";
                  const isSelected = selectedKey === tpl.key;
                  return (
                    <button
                      key={tpl.key}
                      type="button"
                      onClick={() => handleSettingChange("company.quote_template", tpl.key)}
                    ...
                    >
                      ...
                      <div
                        className={`w-full aspect-[4/3] rounded-lg overflow-hidden border mb-3 bg-white transition-colors ${
                          isSelected ? "border-primary/30" : "border-slate-100 dark:border-slate-800"
                        }`}
                      >
                        {tpl.svg}
                      </div>
                      <p className="font-semibold text-sm text-slate-900 dark:text-slate-100">{tpl.label}</p>
                      <p className="text-xs text-slate-500 dark:text-slate-400 mt-1 leading-snug">{tpl.desc}</p>
                    </button>
                  );
                })}
              </div>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Formato del codice generato automaticamente per ogni preventivo
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => handleSettingChange("quotes.code_prefix", e.target.value.toUpperCase())}
                    placeholder="PREV"
                    className="font-mono uppercase"
                  />
                  <p className="text-xs text-slate-500 dark:text-slate-400">
                    Testo fisso all&apos;inizio del codice (es. PREV, PRV, OFF)
                  </p>
                </div>
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => handleSettingChange("quotes.code_format", e.target.value)}
                  ...
                  <div className="rounded-lg border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800/50 p-3 space-y-2">
                    <p className="text-xs font-medium text-slate-700 dark:text-slate-300">Segnaposto disponibili:</p>
                    <div className="grid grid-cols-2 gap-x-4 gap-y-1 text-xs text-slate-600 dark:text-slate-400">
                      <div><code className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 px-1 rounded text-[11px]">{"{prefix}"}</code> — prefisso (es. PREV)</div>
                      <div><code className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 px-1 rounded text-[11px]">{"{year}"}</code> — anno 4 cifre (es. 2026)</div>
                      <div><code className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 px-1 rounded text-[11px]">{"{year:2}"}</code> — anno 2 cifre (es. 26)</div>
                      <div><code className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 px-1 rounded text-[11px]">{"{month}"}</code> — mese (es. 02)</div>
                      <div><code className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 px-1 rounded text-[11px]">{"{day}"}</code> — giorno (es. 17)</div>
                      <div><code className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 px-1 rounded text-[11px]">{"{number:4}"}</code> — prog. annuale (es. 0001)</div>
                      <div><code className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 px-1 rounded text-[11px]">{"{number:4:monthly}"}</code> — prog. mensile</div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              {(() => {
                ...
                const preview = (getSettingValue("quotes.code_format") || "{prefix}-{year}-{number:4}")
                  .replace("{prefix}", getSettingValue("quotes.code_prefix") || "PREV")
                  .replace("{year:2}", yy)
                  .replace("{year}", now.getFullYear().toString())
                  .replace("{month}", mm)
                  .replace("{day}", dd)
                  .replace("{date}", `${now.getFullYear()}${mm}${dd}`)
                  .replace(/\{number:(\d+):monthly\}/, (_, n) => "1".padStart(parseInt(n), "0"))
                  .replace(/\{number:(\d+)\}/, (_, n) => "1".padStart(parseInt(n), "0"));
                return (
                  <div className="flex items-center gap-2 p-3 rounded-lg bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700">
                    <span className="text-xs text-slate-500 dark:text-slate-400">Anteprima:</span>
                    <code className="text-sm font-mono font-semibold text-slate-800 dark:text-slate-200">{preview}</code>
                  </div>
                );
              })()}
            </CardContent>
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-base">Impostazioni predefinite PDF</CardTitle>
              <CardDescription>
                Valori usati come default nella creazione di nuovi preventivi
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              {/* Validità */}
              <div className="space-y-2">
                <Label htmlFor="validity_days">Giorni di validità predefiniti</Label>
                <div className="flex items-center gap-3">
                  <Input
                    id="validity_days"
                    type="number"
                    ...
                    onChange={(e) => handleSettingChange("quotes.default_validity_days", e.target.value)}
                    className="w-28"
                  />
                  <span className="text-sm text-slate-500 dark:text-slate-400">giorni dalla data di emissione</span>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                {(
                  [
                    { key: "quotes.show_unit_prices_by_default",            label: "Mostra prezzi unitari",      desc: "Colonna prezzo per singola voce" },
                    { key: "quotes.show_product_codes_by_default",           label: "Mostra codici prodotto",     desc: "Codice articolo accanto alla descrizione" },
                    { key: "quotes.show_vat_by_default",                     label: "Mostra aliquota IVA",        desc: "Colonna % IVA nella tabella" },
                    { key: "quotes.show_section_totals_by_default",          label: "Mostra totali di sezione",   desc: "Subtotale per ogni sezione raggruppata" },
                    { key: "quotes.vat_included_in_prices_by_default",       label: "Prezzi IVA inclusa",         desc: "I prezzi unitari includono già l'IVA" },
                    { key: "quotes.tax_included_by_default",                 label: "Totale IVA inclusa",         desc: "Il totale finale include l'IVA" },
                    { key: "quotes.include_terms_and_conditions_by_default", label: "Includi condizioni generali",desc: "Aggiungi T&C al fondo del preventivo" },
                  ] as const
                ).map(({ key, label, desc }) => (
                  <div
                    key={key}
                  ...
                  >
                    <Switch
                      id={key}
                      checked={getSettingValue(key) === "true" || getSettingValue(key) === "1"}
                      onCheckedChange={(checked) => handleSettingChange(key, checked ? "1" : "0")}
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Testi precompilati nei nuovi preventivi, modificabili per ogni singolo documento
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  onChange={(e) => handleSettingChange("quotes.default_notes", e.target.value)}
              ...
              <div className="space-y-2">
                <Label htmlFor="terms_template">Condizioni generali predefinite</Label>
                <Textarea
                  id="terms_template"
                  value={getSettingValue("quotes.terms_and_conditions_template")}
                  onChange={(e) => handleSettingChange("quotes.terms_and_conditions_template", e.target.value)}
