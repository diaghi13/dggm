...
export default function DdtsPage() {
  ...
  const columns = useMemo(
    () =>
      createDdtsColumns(
        (ddt) => {
          router.push(`/dashboard/ddts/${ddt.id}`);
        },
        (ddt) => {
          setSelectedDdt(ddt);
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <Button onClick={() => router.push('/dashboard/ddts/new')}>
      ...
      <Card>
        ...
        <CardContent>
          <DataTable
            ...
            onRowClick={(ddt) => router.push(`/dashboard/ddts/${ddt.id}`)}
            emptyState={
              <div className="text-center py-12">
                ...
                {!warehouseFilter && !typeFilter && !statusFilter && (
                  <Button className="mt-4" onClick={() => router.push('/dashboard/ddts/new')}>
                    <Plus className="mr-2 h-4 w-4" />
                    Crea Primo DDT
                  </Button>
                )}
